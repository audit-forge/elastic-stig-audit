"""Evidence bundle output for elastic-stig-audit.
...
def _summary_text(results, target_info: dict, summary: dict) -> str:
    lines = [
        "elastic-stig-audit — CIS Elasticsearch Container Security Evidence Bundle",
    ...
    with zipfile.ZipFile(buf, mode="w", compression=zipfile.ZIP_DEFLATED) as zf:
        ...
        for r in results:
            ev_doc = {
                ...
                "nist_800_171": r.nist_800_171,
                "cmmc_level": r.cmmc_level,
                "mitre_attack": r.mitre_attack,
                "mitre_d3fend": r.mitre_d3fend,
